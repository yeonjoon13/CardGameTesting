...
// Blackbox unit testing of Deck class
public class DeckBBTest {
    ...
    public void testCardGetCardNumber() {
        ...
        assertEquals(2, card1.getCardNumber());
        assertEquals(4, card2.getCardNumber());
        assertEquals(14, card3.getCardNumber());
    }

    @Test
    // Test the method getFileName.
    public void testCardGetFileName() {
        Card card = new Card(Card.Cards.Ace, Card.Suits.Spades);
        assertEquals("Cards/Ace of Spades.gif", card.getFileName());
    }
